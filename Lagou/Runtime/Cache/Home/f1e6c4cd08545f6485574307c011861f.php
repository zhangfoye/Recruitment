...
<section class="content_box cleafix">
	...
	<div class="left_area fl">
		...
		<form id="loginForm">
		<h2 style="color: #000;padding-left:100px " >企业版登录</h2>
...
<script type="text/javascript">
	...
	function dologin(){
		if(phonefun() && code1()&& passwordfun()){
		 $.ajax({
            type:'post',             //请求方式GET
            url :'/lagouwang/Home/Public/com_doLogin',           //ajax请求地址
            data:$(loginForm).serialize(), //请求传递的参数
            dataType:'json',        //预期服务器返回的数据类型
            async : true,           //是否异步
            success: function(data){
            	if(data == 1){
                window.location.href="/lagouwang/Home/Company/index";
