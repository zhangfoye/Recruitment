                    ...
                    <div class="content_mid">
                        <dl class="c_section c_section_mid">
                            ...
                            <dd>
                                ...
                                <img width="668" height="56" class="c_steps" alt="第四步" src="/lagouwang/Public/style/images/step4.png">
                                <form method="post" action="/lagouwang/Home/Company/doadd4">
                                    <h3>公司介绍</h3>
                                    <textarea placeholder="请分段详细描述公司简介、企业文化等" name="describe"></textarea>
                                    <div class="word_count">你还可以输入
                                        <span>1000</span>字</div>
                                    <input type="submit" value="保存，完成" class="btn_big fr"></form>
                            </dd>
                        </dl>
                    </div>
                    <div class="clear"></div>
            ...
            <div id="footer">
                <div class="wrapper">
                    ...
                    <div class="copyright">&copy;2013-2014 Lagou
                        <a href="" target="_blank">京ICP备14023790号-2</a></div>
                </div>
            </div>
        </body>
