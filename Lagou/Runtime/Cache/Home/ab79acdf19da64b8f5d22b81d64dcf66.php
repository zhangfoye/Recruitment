       ...
       <!-- 页面主体START -->
            ...
            <div class="position-content ">
                <div class="position-content-l">
                    <div class="job-name" title="PHP开发工程师">
                        <div class="company"><?php echo ($cominfo["com_name"]); echo ($info["depart"]); ?>招聘</div>
                        <span class="name"><?php echo ($info["name"]); ?></span>
                        <div class="marEdit"></div>
                    </div>
                    <dd class="job_request">
                        <p>
                            <span class="salary"><?php echo (substr($info["wages"],0,1)); ?>k-<?php echo (substr($info["wages"],2,3)); ?>k</span>
                            <span>/<?php echo ($info["city"]); ?> /</span>
                            <span>经验<?php echo ($expe["name"]); ?> /</span>
                        ...
                        <p class="publish_time"><?php echo (date("Y-m-d H:i",$info["addtime"])); ?>&nbsp; 发布于拉勾网</p></dd>
                </div>
                    ...
                    <ul class="resume-select clearfix">
                        <li class="resume no-resume-attachment">
                            ...
                            <form id="resume">
                                ...
                                <input type="hidden" name="post_id" value="<?php echo ($info["id"]); ?>">
                                <input type="hidden" name="jobs" value="<?php echo ($info["name"]); ?>">
                                <input type="hidden" name="wages" value="<?php echo ($info["wages"]); ?>">
                                <input type="hidden" name="firm_name" value="<?php echo ($cominfo["com_name"]); ?>">
                                <input type="hidden" name="work_address" value="<?php echo ($info["city"]); ?>">
                                <input type="hidden" name="face_test_address" value="<?php echo ($info["address"]); ?>">

                                <a class="passport_login_pop" rel="nofollow" href="#">
                                   </i>上传附件简历</a>
                            </span>
                        </li>
        ...
        <div class="ceil">
            <div class="ceil-content">
                <span class="ceil-job">PHP开发工程师 /</span>
                <span class="ceil-salary">15k-30k</span>
        ...
        <div class="container clearfix" id="container">
            <div class="content_l fl">
                ...
                <div class="popular_recom hide-recom">
                    <a rel="nofollow" href="javascript:;" class="expansion">展开
                        <i></i>
                    </a>
 ...
 <script type="text/javascript">
   ...
   // var  marker;
    ...
    function Delivery(){
         $.ajax({
            type:'post',             //请求方式GET
            url :'/lagouwang/Home/Position/delivery',           //ajax请求地址
