...
<html>
    ...
    <head>
        ...
        <link href="/lagouwang/Public/style/css/popup.css" type="text/css" rel="stylesheet"></head>
                ...
                <div class="content_mid">
                    ...
                    <dl class="c_section c_section_mid">
                        ...
                        <dd class="c_notice">
                            ...
                            <a class="greylink" href="/lagouwang/Home/Position/index?uid=<?php echo ($uid); ?>">发布新职位</a>
                            <a class="greylink" href="/lagouwang/Home/ComIndex/index?uid=<?php echo ($uid); ?>">进入我的公司主页</a></dd>
                    </dl>
                </div>
                <div class="clear"></div>
